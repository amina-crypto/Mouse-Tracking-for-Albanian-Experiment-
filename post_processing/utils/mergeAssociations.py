...
class associationMerger:
    ...
    def __read_file(self) -> List[Dict]:
        ...
        """
        with open(self.in_data_path, 'r', encoding='utf-8') as csvfile:
    ...
    def write_out_denoise_merged_associations(self) -> None:
        ...
        with open(f'{self.out_data_path}/{self.out_data_merged_denoise_name}', 'w', newline='', encoding='utf-8') as out_csvfile:
